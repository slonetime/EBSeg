...
from ebseg.data import build_detection_test_loader, build_detection_train_loader
from ebseg.utils import WandbWriter, setup_wandb
import ebseg.model.mask2former.modeling
from ebseg.model import EBSeg
    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            for module_param_name, value in module.named_parameters(recurse=False):
                ...
                if "side_adapter_network" or "backbone" in module_name:
                    hyperparams["lr"] = (
...
def setup(args):
    ...
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="ebseg")
    return cfg
...
def main(args):
    ...
    if args.eval_only:
        ...
        print(f'aplha={model.inference_alpha}, beta={model.inference_beta}, gamma={model.inference_gamma}')
    ...
    trainer.scheduler.max_iters = cfg.SOLVER.MAX_ITER
